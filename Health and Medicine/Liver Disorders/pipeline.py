"""
Unified tabular regression benchmark pipeline - Liver Disorders dataset.
...
Dataset:
- UCI Liver Disorders dataset, id=60
- 345 samples, 5 numeric features
- Targets: drinks
- This script uses drinks.
...
RANDOM_STATE = 42
DATASET_ID = 60
LOCAL_DATA_FILE = "bupa.data"                               # Local data file would be used when online loading fails
...
DATASET_NAME = "Liver Disorders"                            # Dataset name
DOMAIN = "Health and Medicine"                              # Dataset domain description for reporting
DROP_LIST = ["selector"]                                    # Columns excluded from model features, usually IDs or non-predictive variables
TARGET_COLUMN = "drinks"                                    # Main prediction target for this regression
TARGET_LIST = ["drinks"]                                    # Target-related columns removed from input features to avoid leakage.
